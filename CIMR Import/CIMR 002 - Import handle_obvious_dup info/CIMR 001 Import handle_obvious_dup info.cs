...
public static class CitaviMacro{
	...
	// user settings for import ------------------------------------------------
		...
		string[] excelColNames = new string[3]; 
		excelColNames[0] = "ID"; // excel column name to be merged by (=Citavi-ID)
		excelColNames[1] = "obv_dup_id";     // excel column to be read from #1
		excelColNames[2] = "PubMed ID";      // excel column to be read from #2
		// excelColNames[3] = "clean_title";    // excel column to be read from #3      
		// excelColNames[4] = "clean_title_id"; // excel column to be read from #4
		// excelColNames[5] = "has_obv_dup";    // excel column to be read from #5

		// define names of citavi fields to be written into
		ReferencePropertyId[] citaviField = new ReferencePropertyId[3];
		...
		citaviField[2] = ReferencePropertyId.PubMedId;        // citavi field to be written into #2
		...
		// citaviField[5] = ReferencePropertyId.CustomField5;    // citavi field to be written into #5
